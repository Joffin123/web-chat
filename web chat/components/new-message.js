class NewMessage extends Component {
  ...
  initListeners() {
    ...
    this._soundRecordBtn.addEventListener(
      "mousedown",
      this._onRecordStart.bind(this)
    )
    this._soundRecordBtn.addEventListener(
      "touchstart",
      this._onRecordStart.bind(this)
  ...
  removeListeners() {
    ...
    this._textSendButton.removeEventListener(
      "click",
      this._onTextSend.bind(this)
    )
    this._soundRecordBtn.removeEventListener(
      "mousedown",
      this._onRecordStart.bind(this)
    )
    this._soundRecordBtn.removeEventListener(
