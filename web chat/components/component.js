...
class Component extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (this.onMount && typeof this.onMount === "function") this.onMount()
  }
  ...
  disconnectedCallback() {
    ...
    if (this.onUnmount && typeof this.onUnmount === "function") this.onUnmount()
  }
  ...
  assert(condition, error) {
    if (!condition) console.error(`Warning: ${error}`)
  }
